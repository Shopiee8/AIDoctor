...
export function Step5Payment() {
    const { doctor, appointmentDate, appointmentTime, services, nextStep, prevStep } = useBookingStore();
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <Tabs defaultValue="credit-card">
                            ...
                            <TabsContent value="credit-card" className="mt-4 space-y-4">
                             ...
                             <TabsContent value="paypal">Paypal form goes here.</TabsContent>
                            <TabsContent value="stripe">Stripe form goes here.</TabsContent>
                        </Tabs>
                    </div>
                    <div className="bg-muted/50 p-6 rounded-lg space-y-4">
                        ...
                        <div className="space-y-2 text-sm border-t pt-4">
                            ...
                            <div className="flex justify-between"><p className="text-muted-foreground">Discount</p><p className="font-medium text-destructive">-${discount.toFixed(2)}</p></div>
                        </div>

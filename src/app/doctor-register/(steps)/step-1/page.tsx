        ...
        <Card className="w-full">
            <CardHeader className="text-center">
                ...
                <div className="flex justify-center gap-2 my-4">
                    <Link href="/doctor-register/step-1" className="flex items-center justify-center w-8 h-8 rounded-full bg-primary text-primary-foreground font-bold">1</Link>
                    <Link href="/doctor-register/step-2" className="flex items-center justify-center w-8 h-8 rounded-full bg-gray-200 text-gray-500 font-bold">2</Link>
            ...
            <CardContent>
                <form action="/doctor-register/step-2">

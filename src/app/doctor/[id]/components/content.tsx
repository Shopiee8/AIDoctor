...
// Placeholder for images - replace with actual imports from your project
const IMG01 = '/images/doctors/doctor-01.jpg';
const IMG02 = '/images/doctors/doctor-02.jpg';
const IMG03 = '/images/doctors/doctor-03.jpg';
const IMG04 = '/images/doctors/doctor-04.jpg';
const IMG07 = '/images/features/feature-01.jpg';
const IMG08 = '/images/features/feature-02.jpg';

// Placeholder for patient images
const patient = '/images/patients/patient.jpg';
const patient1 = '/images/patients/patient1.jpg';
const patient2 = '/images/patients/patient2.jpg';
                        ...
                        <ul>
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG07} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG08} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                          ...
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG01} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                        </ul>
                      </div>
                    ...
                    <div className="clinic-content">
                      ...
                      <div className="clinic-details mb-0">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG02} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG03} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                          <li>
                            <Link href="#" data-fancybox="gallery2">
                              <Image src={IMG04} alt="Feature Image" width={50} height={50} />
                            </Link>
                          </li>
                        </ul>
                      </div>
